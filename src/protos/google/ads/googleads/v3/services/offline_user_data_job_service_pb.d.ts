...
// file: google/ads/googleads/v3/services/offline_user_data_job_service.proto
...
export class CreateOfflineUserDataJobRequest extends jspb.Message {
  ...
  hasJob(): boolean;
  clearJob(): void;
  getJob(): google_ads_googleads_v3_resources_offline_user_data_job_pb.OfflineUserDataJob | undefined;
  setJob(value?: google_ads_googleads_v3_resources_offline_user_data_job_pb.OfflineUserDataJob): void;
...
export namespace CreateOfflineUserDataJobRequest {
  export type AsObject = {
    customerId: string,
    job?: google_ads_googleads_v3_resources_offline_user_data_job_pb.OfflineUserDataJob.AsObject,
  }
}
...
export class OfflineUserDataJobOperation extends jspb.Message {
  hasCreate(): boolean;
  clearCreate(): void;
  getCreate(): google_ads_googleads_v3_common_offline_user_data_pb.UserData | undefined;
  setCreate(value?: google_ads_googleads_v3_common_offline_user_data_pb.UserData): void;

  hasRemove(): boolean;
  clearRemove(): void;
  getRemove(): google_ads_googleads_v3_common_offline_user_data_pb.UserData | undefined;
  setRemove(value?: google_ads_googleads_v3_common_offline_user_data_pb.UserData): void;
...
export namespace OfflineUserDataJobOperation {
  export type AsObject = {
    create?: google_ads_googleads_v3_common_offline_user_data_pb.UserData.AsObject,
    remove?: google_ads_googleads_v3_common_offline_user_data_pb.UserData.AsObject,
    removeAll: boolean,
  }
