...
// file: google/ads/googleads/v3/services/customer_manager_link_service.proto
...
export class MoveManagerLinkRequest extends jspb.Message {
  getCustomerId(): string;
  setCustomerId(value: string): void;

  getPreviousCustomerManagerLink(): string;
  setPreviousCustomerManagerLink(value: string): void;

  getNewManager(): string;
  setNewManager(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MoveManagerLinkRequest.AsObject;
  static toObject(includeInstance: boolean, msg: MoveManagerLinkRequest): MoveManagerLinkRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: MoveManagerLinkRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MoveManagerLinkRequest;
  static deserializeBinaryFromReader(message: MoveManagerLinkRequest, reader: jspb.BinaryReader): MoveManagerLinkRequest;
}

export namespace MoveManagerLinkRequest {
  export type AsObject = {
    customerId: string,
...
export class CustomerManagerLinkOperation extends jspb.Message {
  ...
  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v3_resources_customer_manager_link_pb.CustomerManagerLink | undefined;
  setUpdate(value?: google_ads_googleads_v3_resources_customer_manager_link_pb.CustomerManagerLink): void;
...
export namespace CustomerManagerLinkOperation {
  export type AsObject = {
    ...
    update?: google_ads_googleads_v3_resources_customer_manager_link_pb.CustomerManagerLink.AsObject,
  }
...
export class MoveManagerLinkResponse extends jspb.Message {
  getResourceName(): string;
  setResourceName(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MoveManagerLinkResponse.AsObject;
  static toObject(includeInstance: boolean, msg: MoveManagerLinkResponse): MoveManagerLinkResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: MoveManagerLinkResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MoveManagerLinkResponse;
  static deserializeBinaryFromReader(message: MoveManagerLinkResponse, reader: jspb.BinaryReader): MoveManagerLinkResponse;
}

export namespace MoveManagerLinkResponse {
  export type AsObject = {
    resourceName: string,
  }
}
