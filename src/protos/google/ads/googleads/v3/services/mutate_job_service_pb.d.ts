...
// file: google/ads/googleads/v3/services/mutate_job_service.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v3_resources_mutate_job_pb from "../../../../../google/ads/googleads/v3/resources/mutate_job_pb";
import * as google_ads_googleads_v3_services_google_ads_service_pb from "../../../../../google/ads/googleads/v3/services/google_ads_service_pb";
...
export class AddMutateJobOperationsRequest extends jspb.Message {
  ...
  getMutateOperationsList(): Array<google_ads_googleads_v3_services_google_ads_service_pb.MutateOperation>;
  setMutateOperationsList(value: Array<google_ads_googleads_v3_services_google_ads_service_pb.MutateOperation>): void;
  addMutateOperations(value?: google_ads_googleads_v3_services_google_ads_service_pb.MutateOperation, index?: number): google_ads_googleads_v3_services_google_ads_service_pb.MutateOperation;
...
export namespace AddMutateJobOperationsRequest {
  export type AsObject = {
    ...
    mutateOperationsList: Array<google_ads_googleads_v3_services_google_ads_service_pb.MutateOperation.AsObject>,
  }
}
...
export class MutateJobResult extends jspb.Message {
  ...
  getMutateOperationResponse(): google_ads_googleads_v3_services_google_ads_service_pb.MutateOperationResponse | undefined;
  setMutateOperationResponse(value?: google_ads_googleads_v3_services_google_ads_service_pb.MutateOperationResponse): void;
...
export namespace MutateJobResult {
  export type AsObject = {
    ...
    mutateOperationResponse?: google_ads_googleads_v3_services_google_ads_service_pb.MutateOperationResponse.AsObject,
