...
// file: google/ads/googleads/v3/services/customer_service.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v3_enums_access_role_pb from "../../../../../google/ads/googleads/v3/enums/access_role_pb";
...
export class CreateCustomerClientRequest extends jspb.Message {
  ...
  getCustomerClient(): google_ads_googleads_v3_resources_customer_pb.Customer | undefined;
  setCustomerClient(value?: google_ads_googleads_v3_resources_customer_pb.Customer): void;
...
export class CustomerOperation extends jspb.Message {
  hasUpdate(): boolean;
  clearUpdate(): void;
  getUpdate(): google_ads_googleads_v3_resources_customer_pb.Customer | undefined;
  setUpdate(value?: google_ads_googleads_v3_resources_customer_pb.Customer): void;
...
export namespace CustomerOperation {
  export type AsObject = {
    update?: google_ads_googleads_v3_resources_customer_pb.Customer.AsObject,
