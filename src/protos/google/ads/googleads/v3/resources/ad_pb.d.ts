...
// file: google/ads/googleads/v3/resources/ad.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v3_common_ad_type_infos_pb from "../../../../../google/ads/googleads/v3/common/ad_type_infos_pb";
import * as google_ads_googleads_v3_common_custom_parameter_pb from "../../../../../google/ads/googleads/v3/common/custom_parameter_pb";
import * as google_ads_googleads_v3_common_final_app_url_pb from "../../../../../google/ads/googleads/v3/common/final_app_url_pb";
import * as google_ads_googleads_v3_common_url_collection_pb from "../../../../../google/ads/googleads/v3/common/url_collection_pb";
...
export class Ad extends jspb.Message {
  ...
  getFinalAppUrlsList(): Array<google_ads_googleads_v3_common_final_app_url_pb.FinalAppUrl>;
  setFinalAppUrlsList(value: Array<google_ads_googleads_v3_common_final_app_url_pb.FinalAppUrl>): void;
  addFinalAppUrls(value?: google_ads_googleads_v3_common_final_app_url_pb.FinalAppUrl, index?: number): google_ads_googleads_v3_common_final_app_url_pb.FinalAppUrl;
  ...
  setUrlCollectionsList(value: Array<google_ads_googleads_v3_common_url_collection_pb.UrlCollection>): void;
  addUrlCollections(value?: google_ads_googleads_v3_common_url_collection_pb.UrlCollection, index?: number): google_ads_googleads_v3_common_url_collection_pb.UrlCollection;
  ...
  hasTextAd(): boolean;
  clearTextAd(): void;
  getTextAd(): google_ads_googleads_v3_common_ad_type_infos_pb.TextAdInfo | undefined;
  setTextAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.TextAdInfo): void;

  hasExpandedTextAd(): boolean;
  clearExpandedTextAd(): void;
  getExpandedTextAd(): google_ads_googleads_v3_common_ad_type_infos_pb.ExpandedTextAdInfo | undefined;
  setExpandedTextAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.ExpandedTextAdInfo): void;

  hasCallOnlyAd(): boolean;
  clearCallOnlyAd(): void;
  getCallOnlyAd(): google_ads_googleads_v3_common_ad_type_infos_pb.CallOnlyAdInfo | undefined;
  setCallOnlyAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.CallOnlyAdInfo): void;

  hasExpandedDynamicSearchAd(): boolean;
  clearExpandedDynamicSearchAd(): void;
  getExpandedDynamicSearchAd(): google_ads_googleads_v3_common_ad_type_infos_pb.ExpandedDynamicSearchAdInfo | undefined;
  setExpandedDynamicSearchAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.ExpandedDynamicSearchAdInfo): void;

  hasHotelAd(): boolean;
  clearHotelAd(): void;
  getHotelAd(): google_ads_googleads_v3_common_ad_type_infos_pb.HotelAdInfo | undefined;
  setHotelAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.HotelAdInfo): void;

  hasShoppingSmartAd(): boolean;
  clearShoppingSmartAd(): void;
  getShoppingSmartAd(): google_ads_googleads_v3_common_ad_type_infos_pb.ShoppingSmartAdInfo | undefined;
  setShoppingSmartAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.ShoppingSmartAdInfo): void;

  hasShoppingProductAd(): boolean;
  clearShoppingProductAd(): void;
  getShoppingProductAd(): google_ads_googleads_v3_common_ad_type_infos_pb.ShoppingProductAdInfo | undefined;
  setShoppingProductAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.ShoppingProductAdInfo): void;

  hasGmailAd(): boolean;
  clearGmailAd(): void;
  getGmailAd(): google_ads_googleads_v3_common_ad_type_infos_pb.GmailAdInfo | undefined;
  setGmailAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.GmailAdInfo): void;

  hasImageAd(): boolean;
  clearImageAd(): void;
  getImageAd(): google_ads_googleads_v3_common_ad_type_infos_pb.ImageAdInfo | undefined;
  setImageAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.ImageAdInfo): void;

  hasVideoAd(): boolean;
  clearVideoAd(): void;
  getVideoAd(): google_ads_googleads_v3_common_ad_type_infos_pb.VideoAdInfo | undefined;
  setVideoAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.VideoAdInfo): void;

  hasResponsiveSearchAd(): boolean;
  clearResponsiveSearchAd(): void;
  getResponsiveSearchAd(): google_ads_googleads_v3_common_ad_type_infos_pb.ResponsiveSearchAdInfo | undefined;
  setResponsiveSearchAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.ResponsiveSearchAdInfo): void;

  hasLegacyResponsiveDisplayAd(): boolean;
  clearLegacyResponsiveDisplayAd(): void;
  getLegacyResponsiveDisplayAd(): google_ads_googleads_v3_common_ad_type_infos_pb.LegacyResponsiveDisplayAdInfo | undefined;
  setLegacyResponsiveDisplayAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.LegacyResponsiveDisplayAdInfo): void;

  hasAppAd(): boolean;
  clearAppAd(): void;
  getAppAd(): google_ads_googleads_v3_common_ad_type_infos_pb.AppAdInfo | undefined;
  setAppAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.AppAdInfo): void;

  hasLegacyAppInstallAd(): boolean;
  clearLegacyAppInstallAd(): void;
  getLegacyAppInstallAd(): google_ads_googleads_v3_common_ad_type_infos_pb.LegacyAppInstallAdInfo | undefined;
  setLegacyAppInstallAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.LegacyAppInstallAdInfo): void;

  hasResponsiveDisplayAd(): boolean;
  clearResponsiveDisplayAd(): void;
  getResponsiveDisplayAd(): google_ads_googleads_v3_common_ad_type_infos_pb.ResponsiveDisplayAdInfo | undefined;
  setResponsiveDisplayAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.ResponsiveDisplayAdInfo): void;

  hasDisplayUploadAd(): boolean;
  clearDisplayUploadAd(): void;
  getDisplayUploadAd(): google_ads_googleads_v3_common_ad_type_infos_pb.DisplayUploadAdInfo | undefined;
  setDisplayUploadAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.DisplayUploadAdInfo): void;

  hasAppEngagementAd(): boolean;
  clearAppEngagementAd(): void;
  getAppEngagementAd(): google_ads_googleads_v3_common_ad_type_infos_pb.AppEngagementAdInfo | undefined;
  setAppEngagementAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.AppEngagementAdInfo): void;

  hasShoppingComparisonListingAd(): boolean;
  clearShoppingComparisonListingAd(): void;
  getShoppingComparisonListingAd(): google_ads_googleads_v3_common_ad_type_infos_pb.ShoppingComparisonListingAdInfo | undefined;
  setShoppingComparisonListingAd(value?: google_ads_googleads_v3_common_ad_type_infos_pb.ShoppingComparisonListingAdInfo): void;
...
export namespace Ad {
  export type AsObject = {
    ...
    finalAppUrlsList: Array<google_ads_googleads_v3_common_final_app_url_pb.FinalAppUrl.AsObject>,
    ...
    expandedDynamicSearchAd?: google_ads_googleads_v3_common_ad_type_infos_pb.ExpandedDynamicSearchAdInfo.AsObject,
    hotelAd?: google_ads_googleads_v3_common_ad_type_infos_pb.HotelAdInfo.AsObject,
    shoppingSmartAd?: google_ads_googleads_v3_common_ad_type_infos_pb.ShoppingSmartAdInfo.AsObject,
    shoppingProductAd?: google_ads_googleads_v3_common_ad_type_infos_pb.ShoppingProductAdInfo.AsObject,
    gmailAd?: google_ads_googleads_v3_common_ad_type_infos_pb.GmailAdInfo.AsObject,
    imageAd?: google_ads_googleads_v3_common_ad_type_infos_pb.ImageAdInfo.AsObject,
    videoAd?: google_ads_googleads_v3_common_ad_type_infos_pb.VideoAdInfo.AsObject,
    responsiveSearchAd?: google_ads_googleads_v3_common_ad_type_infos_pb.ResponsiveSearchAdInfo.AsObject,
    legacyResponsiveDisplayAd?: google_ads_googleads_v3_common_ad_type_infos_pb.LegacyResponsiveDisplayAdInfo.AsObject,
    appAd?: google_ads_googleads_v3_common_ad_type_infos_pb.AppAdInfo.AsObject,
    legacyAppInstallAd?: google_ads_googleads_v3_common_ad_type_infos_pb.LegacyAppInstallAdInfo.AsObject,
    responsiveDisplayAd?: google_ads_googleads_v3_common_ad_type_infos_pb.ResponsiveDisplayAdInfo.AsObject,
    displayUploadAd?: google_ads_googleads_v3_common_ad_type_infos_pb.DisplayUploadAdInfo.AsObject,
    appEngagementAd?: google_ads_googleads_v3_common_ad_type_infos_pb.AppEngagementAdInfo.AsObject,
    shoppingComparisonListingAd?: google_ads_googleads_v3_common_ad_type_infos_pb.ShoppingComparisonListingAdInfo.AsObject,
  }
