...
// file: google/ads/googleads/v3/resources/ad_group_bid_modifier.proto
...
export class AdGroupBidModifier extends jspb.Message {
  ...
  getHotelDateSelectionType(): google_ads_googleads_v3_common_criteria_pb.HotelDateSelectionTypeInfo | undefined;
  setHotelDateSelectionType(value?: google_ads_googleads_v3_common_criteria_pb.HotelDateSelectionTypeInfo): void;

  hasHotelAdvanceBookingWindow(): boolean;
  clearHotelAdvanceBookingWindow(): void;
  getHotelAdvanceBookingWindow(): google_ads_googleads_v3_common_criteria_pb.HotelAdvanceBookingWindowInfo | undefined;
  setHotelAdvanceBookingWindow(value?: google_ads_googleads_v3_common_criteria_pb.HotelAdvanceBookingWindowInfo): void;

  hasHotelLengthOfStay(): boolean;
  clearHotelLengthOfStay(): void;
  getHotelLengthOfStay(): google_ads_googleads_v3_common_criteria_pb.HotelLengthOfStayInfo | undefined;
  setHotelLengthOfStay(value?: google_ads_googleads_v3_common_criteria_pb.HotelLengthOfStayInfo): void;

  hasHotelCheckInDay(): boolean;
  clearHotelCheckInDay(): void;
  getHotelCheckInDay(): google_ads_googleads_v3_common_criteria_pb.HotelCheckInDayInfo | undefined;
  setHotelCheckInDay(value?: google_ads_googleads_v3_common_criteria_pb.HotelCheckInDayInfo): void;
  ...
  getPreferredContent(): google_ads_googleads_v3_common_criteria_pb.PreferredContentInfo | undefined;
  setPreferredContent(value?: google_ads_googleads_v3_common_criteria_pb.PreferredContentInfo): void;
...
export namespace AdGroupBidModifier {
  export type AsObject = {
    ...
    hotelCheckInDay?: google_ads_googleads_v3_common_criteria_pb.HotelCheckInDayInfo.AsObject,
    device?: google_ads_googleads_v3_common_criteria_pb.DeviceInfo.AsObject,
    preferredContent?: google_ads_googleads_v3_common_criteria_pb.PreferredContentInfo.AsObject,
  }
