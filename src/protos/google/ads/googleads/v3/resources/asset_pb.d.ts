...
// file: google/ads/googleads/v3/resources/asset.proto
...
export class Asset extends jspb.Message {
  ...
  getYoutubeVideoAsset(): google_ads_googleads_v3_common_asset_types_pb.YoutubeVideoAsset | undefined;
  setYoutubeVideoAsset(value?: google_ads_googleads_v3_common_asset_types_pb.YoutubeVideoAsset): void;

  hasMediaBundleAsset(): boolean;
  clearMediaBundleAsset(): void;
  getMediaBundleAsset(): google_ads_googleads_v3_common_asset_types_pb.MediaBundleAsset | undefined;
  setMediaBundleAsset(value?: google_ads_googleads_v3_common_asset_types_pb.MediaBundleAsset): void;

  hasImageAsset(): boolean;
  clearImageAsset(): void;
  getImageAsset(): google_ads_googleads_v3_common_asset_types_pb.ImageAsset | undefined;
  setImageAsset(value?: google_ads_googleads_v3_common_asset_types_pb.ImageAsset): void;

  hasTextAsset(): boolean;
  clearTextAsset(): void;
  getTextAsset(): google_ads_googleads_v3_common_asset_types_pb.TextAsset | undefined;
  setTextAsset(value?: google_ads_googleads_v3_common_asset_types_pb.TextAsset): void;
...
export namespace Asset {
  export type AsObject = {
    ...
    textAsset?: google_ads_googleads_v3_common_asset_types_pb.TextAsset.AsObject,
  }
