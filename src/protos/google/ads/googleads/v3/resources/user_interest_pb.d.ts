...
// file: google/ads/googleads/v3/resources/user_interest.proto
...
export class UserInterest extends jspb.Message {
  ...
  getAvailabilitiesList(): Array<google_ads_googleads_v3_common_criterion_category_availability_pb.CriterionCategoryAvailability>;
  setAvailabilitiesList(value: Array<google_ads_googleads_v3_common_criterion_category_availability_pb.CriterionCategoryAvailability>): void;
  addAvailabilities(value?: google_ads_googleads_v3_common_criterion_category_availability_pb.CriterionCategoryAvailability, index?: number): google_ads_googleads_v3_common_criterion_category_availability_pb.CriterionCategoryAvailability;
...
export namespace UserInterest {
  export type AsObject = {
    ...
    availabilitiesList: Array<google_ads_googleads_v3_common_criterion_category_availability_pb.CriterionCategoryAvailability.AsObject>,
  }
}
