...
// file: google/ads/googleads/v3/resources/ad_group_simulation.proto
...
export class AdGroupSimulation extends jspb.Message {
  ...
  getCpcBidPointList(): google_ads_googleads_v3_common_simulation_pb.CpcBidSimulationPointList | undefined;
  setCpcBidPointList(value?: google_ads_googleads_v3_common_simulation_pb.CpcBidSimulationPointList): void;

  hasCpvBidPointList(): boolean;
  clearCpvBidPointList(): void;
  getCpvBidPointList(): google_ads_googleads_v3_common_simulation_pb.CpvBidSimulationPointList | undefined;
  setCpvBidPointList(value?: google_ads_googleads_v3_common_simulation_pb.CpvBidSimulationPointList): void;

  hasTargetCpaPointList(): boolean;
  clearTargetCpaPointList(): void;
  getTargetCpaPointList(): google_ads_googleads_v3_common_simulation_pb.TargetCpaSimulationPointList | undefined;
  setTargetCpaPointList(value?: google_ads_googleads_v3_common_simulation_pb.TargetCpaSimulationPointList): void;
...
export namespace AdGroupSimulation {
  export type AsObject = {
    ...
    cpvBidPointList?: google_ads_googleads_v3_common_simulation_pb.CpvBidSimulationPointList.AsObject,
    targetCpaPointList?: google_ads_googleads_v3_common_simulation_pb.TargetCpaSimulationPointList.AsObject,
  }
