...
// file: google/ads/googleads/v3/resources/click_view.proto
...
export class ClickView extends jspb.Message {
  ...
  getAreaOfInterest(): google_ads_googleads_v3_common_click_location_pb.ClickLocation | undefined;
  setAreaOfInterest(value?: google_ads_googleads_v3_common_click_location_pb.ClickLocation): void;

  hasLocationOfPresence(): boolean;
  clearLocationOfPresence(): void;
  getLocationOfPresence(): google_ads_googleads_v3_common_click_location_pb.ClickLocation | undefined;
  setLocationOfPresence(value?: google_ads_googleads_v3_common_click_location_pb.ClickLocation): void;
...
export namespace ClickView {
  export type AsObject = {
    ...
    areaOfInterest?: google_ads_googleads_v3_common_click_location_pb.ClickLocation.AsObject,
    locationOfPresence?: google_ads_googleads_v3_common_click_location_pb.ClickLocation.AsObject,
