...
// file: google/ads/googleads/v3/resources/user_list.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v3_common_user_lists_pb from "../../../../../google/ads/googleads/v3/common/user_lists_pb";
import * as google_ads_googleads_v3_enums_access_reason_pb from "../../../../../google/ads/googleads/v3/enums/access_reason_pb";
import * as google_ads_googleads_v3_enums_user_list_access_status_pb from "../../../../../google/ads/googleads/v3/enums/user_list_access_status_pb";
import * as google_ads_googleads_v3_enums_user_list_closing_reason_pb from "../../../../../google/ads/googleads/v3/enums/user_list_closing_reason_pb";
...
export class UserList extends jspb.Message {
  ...
  getCrmBasedUserList(): google_ads_googleads_v3_common_user_lists_pb.CrmBasedUserListInfo | undefined;
  setCrmBasedUserList(value?: google_ads_googleads_v3_common_user_lists_pb.CrmBasedUserListInfo): void;

  hasSimilarUserList(): boolean;
  clearSimilarUserList(): void;
  getSimilarUserList(): google_ads_googleads_v3_common_user_lists_pb.SimilarUserListInfo | undefined;
  setSimilarUserList(value?: google_ads_googleads_v3_common_user_lists_pb.SimilarUserListInfo): void;

  hasRuleBasedUserList(): boolean;
  clearRuleBasedUserList(): void;
  getRuleBasedUserList(): google_ads_googleads_v3_common_user_lists_pb.RuleBasedUserListInfo | undefined;
  setRuleBasedUserList(value?: google_ads_googleads_v3_common_user_lists_pb.RuleBasedUserListInfo): void;

  hasLogicalUserList(): boolean;
  clearLogicalUserList(): void;
  getLogicalUserList(): google_ads_googleads_v3_common_user_lists_pb.LogicalUserListInfo | undefined;
  setLogicalUserList(value?: google_ads_googleads_v3_common_user_lists_pb.LogicalUserListInfo): void;

  hasBasicUserList(): boolean;
  clearBasicUserList(): void;
  getBasicUserList(): google_ads_googleads_v3_common_user_lists_pb.BasicUserListInfo | undefined;
  setBasicUserList(value?: google_ads_googleads_v3_common_user_lists_pb.BasicUserListInfo): void;
...
export namespace UserList {
  export type AsObject = {
    ...
    similarUserList?: google_ads_googleads_v3_common_user_lists_pb.SimilarUserListInfo.AsObject,
    ruleBasedUserList?: google_ads_googleads_v3_common_user_lists_pb.RuleBasedUserListInfo.AsObject,
    logicalUserList?: google_ads_googleads_v3_common_user_lists_pb.LogicalUserListInfo.AsObject,
    basicUserList?: google_ads_googleads_v3_common_user_lists_pb.BasicUserListInfo.AsObject,
  }
