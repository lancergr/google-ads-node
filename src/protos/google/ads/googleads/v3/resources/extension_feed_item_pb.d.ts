...
// file: google/ads/googleads/v3/resources/extension_feed_item.proto
...
export class ExtensionFeedItem extends jspb.Message {
  ...
  getAdSchedulesList(): Array<google_ads_googleads_v3_common_criteria_pb.AdScheduleInfo>;
  ...
  getSitelinkFeedItem(): google_ads_googleads_v3_common_extensions_pb.SitelinkFeedItem | undefined;
  setSitelinkFeedItem(value?: google_ads_googleads_v3_common_extensions_pb.SitelinkFeedItem): void;

  hasStructuredSnippetFeedItem(): boolean;
  clearStructuredSnippetFeedItem(): void;
  getStructuredSnippetFeedItem(): google_ads_googleads_v3_common_extensions_pb.StructuredSnippetFeedItem | undefined;
  setStructuredSnippetFeedItem(value?: google_ads_googleads_v3_common_extensions_pb.StructuredSnippetFeedItem): void;

  hasAppFeedItem(): boolean;
  clearAppFeedItem(): void;
  getAppFeedItem(): google_ads_googleads_v3_common_extensions_pb.AppFeedItem | undefined;
  setAppFeedItem(value?: google_ads_googleads_v3_common_extensions_pb.AppFeedItem): void;

  hasCallFeedItem(): boolean;
  clearCallFeedItem(): void;
  getCallFeedItem(): google_ads_googleads_v3_common_extensions_pb.CallFeedItem | undefined;
  setCallFeedItem(value?: google_ads_googleads_v3_common_extensions_pb.CallFeedItem): void;

  hasCalloutFeedItem(): boolean;
  clearCalloutFeedItem(): void;
  getCalloutFeedItem(): google_ads_googleads_v3_common_extensions_pb.CalloutFeedItem | undefined;
  setCalloutFeedItem(value?: google_ads_googleads_v3_common_extensions_pb.CalloutFeedItem): void;

  hasTextMessageFeedItem(): boolean;
  clearTextMessageFeedItem(): void;
  getTextMessageFeedItem(): google_ads_googleads_v3_common_extensions_pb.TextMessageFeedItem | undefined;
  setTextMessageFeedItem(value?: google_ads_googleads_v3_common_extensions_pb.TextMessageFeedItem): void;

  hasPriceFeedItem(): boolean;
  clearPriceFeedItem(): void;
  getPriceFeedItem(): google_ads_googleads_v3_common_extensions_pb.PriceFeedItem | undefined;
  setPriceFeedItem(value?: google_ads_googleads_v3_common_extensions_pb.PriceFeedItem): void;

  hasPromotionFeedItem(): boolean;
  clearPromotionFeedItem(): void;
  getPromotionFeedItem(): google_ads_googleads_v3_common_extensions_pb.PromotionFeedItem | undefined;
  setPromotionFeedItem(value?: google_ads_googleads_v3_common_extensions_pb.PromotionFeedItem): void;

  hasLocationFeedItem(): boolean;
  clearLocationFeedItem(): void;
  getLocationFeedItem(): google_ads_googleads_v3_common_extensions_pb.LocationFeedItem | undefined;
  setLocationFeedItem(value?: google_ads_googleads_v3_common_extensions_pb.LocationFeedItem): void;

  hasAffiliateLocationFeedItem(): boolean;
  clearAffiliateLocationFeedItem(): void;
  getAffiliateLocationFeedItem(): google_ads_googleads_v3_common_extensions_pb.AffiliateLocationFeedItem | undefined;
  setAffiliateLocationFeedItem(value?: google_ads_googleads_v3_common_extensions_pb.AffiliateLocationFeedItem): void;

  hasHotelCalloutFeedItem(): boolean;
  clearHotelCalloutFeedItem(): void;
  getHotelCalloutFeedItem(): google_ads_googleads_v3_common_extensions_pb.HotelCalloutFeedItem | undefined;
  setHotelCalloutFeedItem(value?: google_ads_googleads_v3_common_extensions_pb.HotelCalloutFeedItem): void;
...
export namespace ExtensionFeedItem {
  export type AsObject = {
    ...
    callFeedItem?: google_ads_googleads_v3_common_extensions_pb.CallFeedItem.AsObject,
    calloutFeedItem?: google_ads_googleads_v3_common_extensions_pb.CalloutFeedItem.AsObject,
    textMessageFeedItem?: google_ads_googleads_v3_common_extensions_pb.TextMessageFeedItem.AsObject,
    priceFeedItem?: google_ads_googleads_v3_common_extensions_pb.PriceFeedItem.AsObject,
    promotionFeedItem?: google_ads_googleads_v3_common_extensions_pb.PromotionFeedItem.AsObject,
    locationFeedItem?: google_ads_googleads_v3_common_extensions_pb.LocationFeedItem.AsObject,
    affiliateLocationFeedItem?: google_ads_googleads_v3_common_extensions_pb.AffiliateLocationFeedItem.AsObject,
    hotelCalloutFeedItem?: google_ads_googleads_v3_common_extensions_pb.HotelCalloutFeedItem.AsObject,
