...
// file: google/ads/googleads/v3/common/ad_type_infos.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v3_common_ad_asset_pb from "../../../../../google/ads/googleads/v3/common/ad_asset_pb";
import * as google_ads_googleads_v3_enums_call_conversion_reporting_state_pb from "../../../../../google/ads/googleads/v3/enums/call_conversion_reporting_state_pb";
import * as google_ads_googleads_v3_enums_display_ad_format_setting_pb from "../../../../../google/ads/googleads/v3/enums/display_ad_format_setting_pb";
import * as google_ads_googleads_v3_enums_display_upload_product_type_pb from "../../../../../google/ads/googleads/v3/enums/display_upload_product_type_pb";
import * as google_ads_googleads_v3_enums_legacy_app_install_ad_app_store_pb from "../../../../../google/ads/googleads/v3/enums/legacy_app_install_ad_app_store_pb";
...
export class VideoTrueViewDiscoveryAdInfo extends jspb.Message {
  hasHeadline(): boolean;
  clearHeadline(): void;
  getHeadline(): google_protobuf_wrappers_pb.StringValue | undefined;
  setHeadline(value?: google_protobuf_wrappers_pb.StringValue): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): VideoTrueViewDiscoveryAdInfo.AsObject;
  static toObject(includeInstance: boolean, msg: VideoTrueViewDiscoveryAdInfo): VideoTrueViewDiscoveryAdInfo.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: VideoTrueViewDiscoveryAdInfo, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): VideoTrueViewDiscoveryAdInfo;
  static deserializeBinaryFromReader(message: VideoTrueViewDiscoveryAdInfo, reader: jspb.BinaryReader): VideoTrueViewDiscoveryAdInfo;
}

export namespace VideoTrueViewDiscoveryAdInfo {
  export type AsObject = {
    headline?: google_protobuf_wrappers_pb.StringValue.AsObject,
    description1?: google_protobuf_wrappers_pb.StringValue.AsObject,
    description2?: google_protobuf_wrappers_pb.StringValue.AsObject,
...
export class VideoAdInfo extends jspb.Message {
  ...
  clearDiscovery(): void;
  getDiscovery(): VideoTrueViewDiscoveryAdInfo | undefined;
  setDiscovery(value?: VideoTrueViewDiscoveryAdInfo): void;
...
export namespace VideoAdInfo {
  export type AsObject = {
    ...
    discovery?: VideoTrueViewDiscoveryAdInfo.AsObject,
  }
...
export class ResponsiveSearchAdInfo extends jspb.Message {
  ...
  getHeadlinesList(): Array<google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset>;
  setHeadlinesList(value: Array<google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset>): void;
  addHeadlines(value?: google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset, index?: number): google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset;

  clearDescriptionsList(): void;
  getDescriptionsList(): Array<google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset>;
  setDescriptionsList(value: Array<google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset>): void;
  addDescriptions(value?: google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset, index?: number): google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset;
...
export namespace ResponsiveSearchAdInfo {
  export type AsObject = {
    headlinesList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset.AsObject>,
    descriptionsList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset.AsObject>,
    path1?: google_protobuf_wrappers_pb.StringValue.AsObject,
    path2?: google_protobuf_wrappers_pb.StringValue.AsObject,
  }
}
...
export class AppAdInfo extends jspb.Message {
  ...
  getMandatoryAdText(): google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset | undefined;
  setMandatoryAdText(value?: google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset): void;
  ...
  getImagesList(): Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset>;
  setImagesList(value: Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset>): void;
  addImages(value?: google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset, index?: number): google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset;

  clearYoutubeVideosList(): void;
  getYoutubeVideosList(): Array<google_ads_googleads_v3_common_ad_asset_pb.AdVideoAsset>;
  setYoutubeVideosList(value: Array<google_ads_googleads_v3_common_ad_asset_pb.AdVideoAsset>): void;
  addYoutubeVideos(value?: google_ads_googleads_v3_common_ad_asset_pb.AdVideoAsset, index?: number): google_ads_googleads_v3_common_ad_asset_pb.AdVideoAsset;

  clearHtml5MediaBundlesList(): void;
  getHtml5MediaBundlesList(): Array<google_ads_googleads_v3_common_ad_asset_pb.AdMediaBundleAsset>;
  setHtml5MediaBundlesList(value: Array<google_ads_googleads_v3_common_ad_asset_pb.AdMediaBundleAsset>): void;
  addHtml5MediaBundles(value?: google_ads_googleads_v3_common_ad_asset_pb.AdMediaBundleAsset, index?: number): google_ads_googleads_v3_common_ad_asset_pb.AdMediaBundleAsset;
...
export namespace AppAdInfo {
  export type AsObject = {
    mandatoryAdText?: google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset.AsObject,
    headlinesList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset.AsObject>,
    descriptionsList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset.AsObject>,
    imagesList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset.AsObject>,
    youtubeVideosList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdVideoAsset.AsObject>,
    html5MediaBundlesList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdMediaBundleAsset.AsObject>,
  }
}
...
export class AppEngagementAdInfo extends jspb.Message {
  ...
  getVideosList(): Array<google_ads_googleads_v3_common_ad_asset_pb.AdVideoAsset>;
  setVideosList(value: Array<google_ads_googleads_v3_common_ad_asset_pb.AdVideoAsset>): void;
  addVideos(value?: google_ads_googleads_v3_common_ad_asset_pb.AdVideoAsset, index?: number): google_ads_googleads_v3_common_ad_asset_pb.AdVideoAsset;
...
export namespace AppEngagementAdInfo {
  export type AsObject = {
    ...
    descriptionsList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset.AsObject>,
    imagesList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset.AsObject>,
    videosList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdVideoAsset.AsObject>,
  }
}
...
export class ResponsiveDisplayAdInfo extends jspb.Message {
  ...
  getMarketingImagesList(): Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset>;
  setMarketingImagesList(value: Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset>): void;
  addMarketingImages(value?: google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset, index?: number): google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset;

  clearSquareMarketingImagesList(): void;
  getSquareMarketingImagesList(): Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset>;
  setSquareMarketingImagesList(value: Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset>): void;
  addSquareMarketingImages(value?: google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset, index?: number): google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset;

  clearLogoImagesList(): void;
  getLogoImagesList(): Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset>;
  setLogoImagesList(value: Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset>): void;
  addLogoImages(value?: google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset, index?: number): google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset;

  clearSquareLogoImagesList(): void;
  getSquareLogoImagesList(): Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset>;
  setSquareLogoImagesList(value: Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset>): void;
  addSquareLogoImages(value?: google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset, index?: number): google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset;
  ...
  hasLongHeadline(): boolean;
  clearLongHeadline(): void;
  getLongHeadline(): google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset | undefined;
  setLongHeadline(value?: google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset): void;
...
export namespace ResponsiveDisplayAdInfo {
  export type AsObject = {
    marketingImagesList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset.AsObject>,
    squareMarketingImagesList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset.AsObject>,
    logoImagesList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset.AsObject>,
    squareLogoImagesList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdImageAsset.AsObject>,
    headlinesList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset.AsObject>,
    longHeadline?: google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset.AsObject,
    descriptionsList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdTextAsset.AsObject>,
    youtubeVideosList: Array<google_ads_googleads_v3_common_ad_asset_pb.AdVideoAsset.AsObject>,
    businessName?: google_protobuf_wrappers_pb.StringValue.AsObject,
    mainColor?: google_protobuf_wrappers_pb.StringValue.AsObject,
...
export class DisplayUploadAdInfo extends jspb.Message {
  ...
  getMediaBundle(): google_ads_googleads_v3_common_ad_asset_pb.AdMediaBundleAsset | undefined;
  setMediaBundle(value?: google_ads_googleads_v3_common_ad_asset_pb.AdMediaBundleAsset): void;
