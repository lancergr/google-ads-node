...
// file: google/ads/googleads/v3/common/policy.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v3_enums_policy_topic_entry_type_pb from "../../../../../google/ads/googleads/v3/enums/policy_topic_entry_type_pb";
import * as google_ads_googleads_v3_enums_policy_topic_evidence_destination_mismatch_url_type_pb from "../../../../../google/ads/googleads/v3/enums/policy_topic_evidence_destination_mismatch_url_type_pb";
import * as google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_device_pb from "../../../../../google/ads/googleads/v3/enums/policy_topic_evidence_destination_not_working_device_pb";
import * as google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_dns_error_type_pb from "../../../../../google/ads/googleads/v3/enums/policy_topic_evidence_destination_not_working_dns_error_type_pb";
...
export class PolicyTopicEntry extends jspb.Message {
  ...
  getType(): google_ads_googleads_v3_enums_policy_topic_entry_type_pb.PolicyTopicEntryTypeEnum.PolicyTopicEntryTypeMap[keyof google_ads_googleads_v3_enums_policy_topic_entry_type_pb.PolicyTopicEntryTypeEnum.PolicyTopicEntryTypeMap];
  setType(value: google_ads_googleads_v3_enums_policy_topic_entry_type_pb.PolicyTopicEntryTypeEnum.PolicyTopicEntryTypeMap[keyof google_ads_googleads_v3_enums_policy_topic_entry_type_pb.PolicyTopicEntryTypeEnum.PolicyTopicEntryTypeMap]): void;
...
export namespace PolicyTopicEntry {
  export type AsObject = {
    ...
    type: google_ads_googleads_v3_enums_policy_topic_entry_type_pb.PolicyTopicEntryTypeEnum.PolicyTopicEntryTypeMap[keyof google_ads_googleads_v3_enums_policy_topic_entry_type_pb.PolicyTopicEntryTypeEnum.PolicyTopicEntryTypeMap],
...
export namespace PolicyTopicEvidence {
  ...
  export class DestinationMismatch extends jspb.Message {
    ...
    getUrlTypesList(): Array<google_ads_googleads_v3_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlTypeMap[keyof google_ads_googleads_v3_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlTypeMap]>;
    setUrlTypesList(value: Array<google_ads_googleads_v3_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlTypeMap[keyof google_ads_googleads_v3_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlTypeMap]>): void;
    addUrlTypes(value: google_ads_googleads_v3_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlTypeMap[keyof google_ads_googleads_v3_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlTypeMap], index?: number): google_ads_googleads_v3_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlTypeMap[keyof google_ads_googleads_v3_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlTypeMap];
  ...
  export namespace DestinationMismatch {
    export type AsObject = {
      urlTypesList: Array<google_ads_googleads_v3_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlTypeMap[keyof google_ads_googleads_v3_enums_policy_topic_evidence_destination_mismatch_url_type_pb.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlTypeMap]>,
    }
  }
  ...
  export class DestinationNotWorking extends jspb.Message {
    ...
    getDevice(): google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_device_pb.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum.PolicyTopicEvidenceDestinationNotWorkingDeviceMap[keyof google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_device_pb.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum.PolicyTopicEvidenceDestinationNotWorkingDeviceMap];
    setDevice(value: google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_device_pb.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum.PolicyTopicEvidenceDestinationNotWorkingDeviceMap[keyof google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_device_pb.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum.PolicyTopicEvidenceDestinationNotWorkingDeviceMap]): void;
    ...
    getDnsErrorType(): google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_dns_error_type_pb.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeMap[keyof google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_dns_error_type_pb.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeMap];
    setDnsErrorType(value: google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_dns_error_type_pb.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeMap[keyof google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_dns_error_type_pb.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeMap]): void;
  ...
  export namespace DestinationNotWorking {
    export type AsObject = {
      ...
      device: google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_device_pb.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum.PolicyTopicEvidenceDestinationNotWorkingDeviceMap[keyof google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_device_pb.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum.PolicyTopicEvidenceDestinationNotWorkingDeviceMap],
      lastCheckedDateTime?: google_protobuf_wrappers_pb.StringValue.AsObject,
      dnsErrorType: google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_dns_error_type_pb.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeMap[keyof google_ads_googleads_v3_enums_policy_topic_evidence_destination_not_working_dns_error_type_pb.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeMap],
