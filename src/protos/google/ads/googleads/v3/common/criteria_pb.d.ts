...
// file: google/ads/googleads/v3/common/criteria.proto

import * as jspb from "google-protobuf";
import * as google_ads_googleads_v3_enums_age_range_type_pb from "../../../../../google/ads/googleads/v3/enums/age_range_type_pb";
import * as google_ads_googleads_v3_enums_app_payment_model_type_pb from "../../../../../google/ads/googleads/v3/enums/app_payment_model_type_pb";
import * as google_ads_googleads_v3_enums_content_label_type_pb from "../../../../../google/ads/googleads/v3/enums/content_label_type_pb";
import * as google_ads_googleads_v3_enums_day_of_week_pb from "../../../../../google/ads/googleads/v3/enums/day_of_week_pb";
import * as google_ads_googleads_v3_enums_device_pb from "../../../../../google/ads/googleads/v3/enums/device_pb";
import * as google_ads_googleads_v3_enums_gender_type_pb from "../../../../../google/ads/googleads/v3/enums/gender_type_pb";
import * as google_ads_googleads_v3_enums_hotel_date_selection_type_pb from "../../../../../google/ads/googleads/v3/enums/hotel_date_selection_type_pb";
import * as google_ads_googleads_v3_enums_income_range_type_pb from "../../../../../google/ads/googleads/v3/enums/income_range_type_pb";
import * as google_ads_googleads_v3_enums_interaction_type_pb from "../../../../../google/ads/googleads/v3/enums/interaction_type_pb";
import * as google_ads_googleads_v3_enums_keyword_match_type_pb from "../../../../../google/ads/googleads/v3/enums/keyword_match_type_pb";
import * as google_ads_googleads_v3_enums_listing_group_type_pb from "../../../../../google/ads/googleads/v3/enums/listing_group_type_pb";
import * as google_ads_googleads_v3_enums_location_group_radius_units_pb from "../../../../../google/ads/googleads/v3/enums/location_group_radius_units_pb";
import * as google_ads_googleads_v3_enums_minute_of_hour_pb from "../../../../../google/ads/googleads/v3/enums/minute_of_hour_pb";
import * as google_ads_googleads_v3_enums_parental_status_type_pb from "../../../../../google/ads/googleads/v3/enums/parental_status_type_pb";
import * as google_ads_googleads_v3_enums_preferred_content_type_pb from "../../../../../google/ads/googleads/v3/enums/preferred_content_type_pb";
...
import * as google_ads_googleads_v3_enums_product_channel_pb from "../../../../../google/ads/googleads/v3/enums/product_channel_pb";
import * as google_ads_googleads_v3_enums_product_channel_exclusivity_pb from "../../../../../google/ads/googleads/v3/enums/product_channel_exclusivity_pb";
import * as google_ads_googleads_v3_enums_product_condition_pb from "../../../../../google/ads/googleads/v3/enums/product_condition_pb";
import * as google_ads_googleads_v3_enums_product_custom_attribute_index_pb from "../../../../../google/ads/googleads/v3/enums/product_custom_attribute_index_pb";
import * as google_ads_googleads_v3_enums_product_type_level_pb from "../../../../../google/ads/googleads/v3/enums/product_type_level_pb";
import * as google_ads_googleads_v3_enums_proximity_radius_units_pb from "../../../../../google/ads/googleads/v3/enums/proximity_radius_units_pb";
import * as google_ads_googleads_v3_enums_webpage_condition_operand_pb from "../../../../../google/ads/googleads/v3/enums/webpage_condition_operand_pb";
import * as google_ads_googleads_v3_enums_webpage_condition_operator_pb from "../../../../../google/ads/googleads/v3/enums/webpage_condition_operator_pb";
...
export class ListingDimensionInfo extends jspb.Message {
  ...
  getProductBrand(): ProductBrandInfo | undefined;
  setProductBrand(value?: ProductBrandInfo): void;
  ...
  hasProductCustomAttribute(): boolean;
  clearProductCustomAttribute(): void;
  getProductCustomAttribute(): ProductCustomAttributeInfo | undefined;
  setProductCustomAttribute(value?: ProductCustomAttributeInfo): void;
...
export namespace ListingDimensionInfo {
  export type AsObject = {
    ...
    productBrand?: ProductBrandInfo.AsObject,
    ...
    productCustomAttribute?: ProductCustomAttributeInfo.AsObject,
...
export class ProductBrandInfo extends jspb.Message {
  hasValue(): boolean;
  clearValue(): void;
  getValue(): google_protobuf_wrappers_pb.StringValue | undefined;
  setValue(value?: google_protobuf_wrappers_pb.StringValue): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ProductBrandInfo.AsObject;
  static toObject(includeInstance: boolean, msg: ProductBrandInfo): ProductBrandInfo.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ProductBrandInfo, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ProductBrandInfo;
  static deserializeBinaryFromReader(message: ProductBrandInfo, reader: jspb.BinaryReader): ProductBrandInfo;
}

export namespace ProductBrandInfo {
  export type AsObject = {
    value?: google_protobuf_wrappers_pb.StringValue.AsObject,
  }
}
...
export class ProductCustomAttributeInfo extends jspb.Message {
  hasValue(): boolean;
  clearValue(): void;
  getValue(): google_protobuf_wrappers_pb.StringValue | undefined;
  setValue(value?: google_protobuf_wrappers_pb.StringValue): void;
  ...
  static toObject(includeInstance: boolean, msg: ProductCustomAttributeInfo): ProductCustomAttributeInfo.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ProductCustomAttributeInfo, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ProductCustomAttributeInfo;
  static deserializeBinaryFromReader(message: ProductCustomAttributeInfo, reader: jspb.BinaryReader): ProductCustomAttributeInfo;
}
