...
// file: google/ads/googleads/v3/errors/resource_count_limit_exceeded_error.proto
...
export namespace ResourceCountLimitExceededErrorEnum {
  ...
  export interface ResourceCountLimitExceededErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    ACCOUNT_LIMIT: 2;
    CAMPAIGN_LIMIT: 3;
  ...
  export const ResourceCountLimitExceededError: ResourceCountLimitExceededErrorMap;
}
