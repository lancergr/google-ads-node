...
// file: google/ads/googleads/v3/errors/campaign_experiment_error.proto
...
export namespace CampaignExperimentErrorEnum {
  ...
  export interface CampaignExperimentErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    DUPLICATE_NAME: 2;
  ...
  export const CampaignExperimentError: CampaignExperimentErrorMap;
}
