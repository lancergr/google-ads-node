...
// file: google/ads/googleads/v3/errors/conversion_action_error.proto
...
export namespace ConversionActionErrorEnum {
  ...
  export interface ConversionActionErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    DUPLICATE_NAME: 2;
    DUPLICATE_APP_ID: 3;
  ...
  export const ConversionActionError: ConversionActionErrorMap;
}
