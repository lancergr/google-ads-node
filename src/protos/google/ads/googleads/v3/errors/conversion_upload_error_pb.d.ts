...
// file: google/ads/googleads/v3/errors/conversion_upload_error.proto
...
export namespace ConversionUploadErrorEnum {
  ...
  export interface ConversionUploadErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const ConversionUploadError: ConversionUploadErrorMap;
}
