...
// file: google/ads/googleads/v3/errors/account_budget_proposal_error.proto
...
export namespace AccountBudgetProposalErrorEnum {
  ...
  export interface AccountBudgetProposalErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const AccountBudgetProposalError: AccountBudgetProposalErrorMap;
}
