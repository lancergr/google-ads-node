...
// file: google/ads/googleads/v3/errors/campaign_draft_error.proto
...
export namespace CampaignDraftErrorEnum {
  ...
  export interface CampaignDraftErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const CampaignDraftError: CampaignDraftErrorMap;
}
