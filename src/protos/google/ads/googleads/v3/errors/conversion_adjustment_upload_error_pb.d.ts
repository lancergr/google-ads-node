...
// file: google/ads/googleads/v3/errors/conversion_adjustment_upload_error.proto
...
export namespace ConversionAdjustmentUploadErrorEnum {
  ...
  export interface ConversionAdjustmentUploadErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const ConversionAdjustmentUploadError: ConversionAdjustmentUploadErrorMap;
}
