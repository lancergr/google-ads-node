...
// file: google/ads/googleads/v3/errors/authentication_error.proto
...
export namespace AuthenticationErrorEnum {
  ...
  export interface AuthenticationErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const AuthenticationError: AuthenticationErrorMap;
}
