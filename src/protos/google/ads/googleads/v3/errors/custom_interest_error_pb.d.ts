...
// file: google/ads/googleads/v3/errors/custom_interest_error.proto
...
export namespace CustomInterestErrorEnum {
  ...
  export interface CustomInterestErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    NAME_ALREADY_USED: 2;
  ...
  export const CustomInterestError: CustomInterestErrorMap;
}
