...
// file: google/ads/googleads/v3/errors/policy_finding_error.proto
...
export namespace PolicyFindingErrorEnum {
  ...
  export interface PolicyFindingErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    POLICY_FINDING: 2;
  ...
  export const PolicyFindingError: PolicyFindingErrorMap;
}
