...
// file: google/ads/googleads/v3/errors/extension_setting_error.proto

import * as jspb from "google-protobuf";
import * as google_api_annotations_pb from "../../../../../google/api/annotations_pb";

export class ExtensionSettingErrorEnum extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ExtensionSettingErrorEnum.AsObject;
  static toObject(includeInstance: boolean, msg: ExtensionSettingErrorEnum): ExtensionSettingErrorEnum.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ExtensionSettingErrorEnum, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ExtensionSettingErrorEnum;
  static deserializeBinaryFromReader(message: ExtensionSettingErrorEnum, reader: jspb.BinaryReader): ExtensionSettingErrorEnum;
}

export namespace ExtensionSettingErrorEnum {
  export type AsObject = {
  }

  export interface ExtensionSettingErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const ExtensionSettingError: ExtensionSettingErrorMap;
}
