...
// file: google/ads/googleads/v3/errors/authorization_error.proto
...
export namespace AuthorizationErrorEnum {
  ...
  export interface AuthorizationErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const AuthorizationError: AuthorizationErrorMap;
}
