...
// file: google/ads/googleads/v3/errors/operation_access_denied_error.proto
...
export namespace OperationAccessDeniedErrorEnum {
  ...
  export interface OperationAccessDeniedErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const OperationAccessDeniedError: OperationAccessDeniedErrorMap;
}
