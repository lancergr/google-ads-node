...
// file: google/ads/googleads/v3/errors/customer_client_link_error.proto
...
export namespace CustomerClientLinkErrorEnum {
  ...
  export interface CustomerClientLinkErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const CustomerClientLinkError: CustomerClientLinkErrorMap;
}
