...
// file: google/ads/googleads/v3/errors/customer_manager_link_error.proto
...
export namespace CustomerManagerLinkErrorEnum {
  ...
  export interface CustomerManagerLinkErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    NO_PENDING_INVITE: 2;
  ...
  export const CustomerManagerLinkError: CustomerManagerLinkErrorMap;
}
