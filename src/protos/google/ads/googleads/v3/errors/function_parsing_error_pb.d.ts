...
// file: google/ads/googleads/v3/errors/function_parsing_error.proto
...
export namespace FunctionParsingErrorEnum {
  ...
  export interface FunctionParsingErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    NO_MORE_INPUT: 2;
  ...
  export const FunctionParsingError: FunctionParsingErrorMap;
}
