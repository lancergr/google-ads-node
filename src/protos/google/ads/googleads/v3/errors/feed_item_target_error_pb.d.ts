...
// file: google/ads/googleads/v3/errors/feed_item_target_error.proto
...
export namespace FeedItemTargetErrorEnum {
  ...
  export interface FeedItemTargetErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const FeedItemTargetError: FeedItemTargetErrorMap;
}
