...
// file: google/ads/googleads/v3/errors/geo_target_constant_suggestion_error.proto
...
export namespace GeoTargetConstantSuggestionErrorEnum {
  ...
  export interface GeoTargetConstantSuggestionErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const GeoTargetConstantSuggestionError: GeoTargetConstantSuggestionErrorMap;
}
