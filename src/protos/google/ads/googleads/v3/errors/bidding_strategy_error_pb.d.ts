...
// file: google/ads/googleads/v3/errors/bidding_strategy_error.proto
...
export namespace BiddingStrategyErrorEnum {
  ...
  export interface BiddingStrategyErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    DUPLICATE_NAME: 2;
  ...
  export const BiddingStrategyError: BiddingStrategyErrorMap;
}
