...
// file: google/ads/googleads/v3/errors/recommendation_error.proto
...
export namespace RecommendationErrorEnum {
  ...
  export interface RecommendationErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const RecommendationError: RecommendationErrorMap;
}
