...
// file: google/ads/googleads/v3/errors/campaign_criterion_error.proto
...
export namespace CampaignCriterionErrorEnum {
  ...
  export interface CampaignCriterionErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const CampaignCriterionError: CampaignCriterionErrorMap;
}
