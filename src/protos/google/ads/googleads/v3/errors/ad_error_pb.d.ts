...
// file: google/ads/googleads/v3/errors/ad_error.proto

import * as jspb from "google-protobuf";
import * as google_api_annotations_pb from "../../../../../google/api/annotations_pb";

export class AdErrorEnum extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): AdErrorEnum.AsObject;
  static toObject(includeInstance: boolean, msg: AdErrorEnum): AdErrorEnum.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: AdErrorEnum, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): AdErrorEnum;
  static deserializeBinaryFromReader(message: AdErrorEnum, reader: jspb.BinaryReader): AdErrorEnum;
}

export namespace AdErrorEnum {
  export type AsObject = {
  }

  export interface AdErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const AdError: AdErrorMap;
}
