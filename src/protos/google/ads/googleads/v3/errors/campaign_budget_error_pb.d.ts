...
// file: google/ads/googleads/v3/errors/campaign_budget_error.proto
...
export namespace CampaignBudgetErrorEnum {
  ...
  export interface CampaignBudgetErrorMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const CampaignBudgetError: CampaignBudgetErrorMap;
}
