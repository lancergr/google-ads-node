...
// file: google/ads/googleads/v3/enums/campaign_criterion_status.proto
...
export namespace CampaignCriterionStatusEnum {
  ...
  export interface CampaignCriterionStatusMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    ENABLED: 2;
    PAUSED: 3;
  ...
  export const CampaignCriterionStatus: CampaignCriterionStatusMap;
}
