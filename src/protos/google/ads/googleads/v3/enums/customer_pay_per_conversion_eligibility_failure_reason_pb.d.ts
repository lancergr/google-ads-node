...
// file: google/ads/googleads/v3/enums/customer_pay_per_conversion_eligibility_failure_reason.proto
...
export namespace CustomerPayPerConversionEligibilityFailureReasonEnum {
  ...
  export interface CustomerPayPerConversionEligibilityFailureReasonMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const CustomerPayPerConversionEligibilityFailureReason: CustomerPayPerConversionEligibilityFailureReasonMap;
}
