...
// file: google/ads/googleads/v3/enums/advertising_channel_sub_type.proto
...
export namespace AdvertisingChannelSubTypeEnum {
  ...
  export interface AdvertisingChannelSubTypeMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    SEARCH_MOBILE_APP: 2;
  ...
  export const AdvertisingChannelSubType: AdvertisingChannelSubTypeMap;
}
