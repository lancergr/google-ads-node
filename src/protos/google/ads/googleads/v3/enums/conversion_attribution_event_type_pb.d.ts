...
// file: google/ads/googleads/v3/enums/conversion_attribution_event_type.proto
...
export namespace ConversionAttributionEventTypeEnum {
  ...
  export interface ConversionAttributionEventTypeMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    IMPRESSION: 2;
    INTERACTION: 3;
  ...
  export const ConversionAttributionEventType: ConversionAttributionEventTypeMap;
}
