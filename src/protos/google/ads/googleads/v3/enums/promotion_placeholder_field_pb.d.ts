...
// file: google/ads/googleads/v3/enums/promotion_placeholder_field.proto
...
export namespace PromotionPlaceholderFieldEnum {
  ...
  export interface PromotionPlaceholderFieldMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    PROMOTION_TARGET: 2;
    DISCOUNT_MODIFIER: 3;
  ...
  export const PromotionPlaceholderField: PromotionPlaceholderFieldMap;
}
