...
// file: google/ads/googleads/v3/enums/conversion_lag_bucket.proto
...
export namespace ConversionLagBucketEnum {
  ...
  export interface ConversionLagBucketMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    LESS_THAN_ONE_DAY: 2;
    ONE_TO_TWO_DAYS: 3;
  ...
  export const ConversionLagBucket: ConversionLagBucketMap;
}
