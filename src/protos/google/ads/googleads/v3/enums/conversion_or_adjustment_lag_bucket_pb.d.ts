...
// file: google/ads/googleads/v3/enums/conversion_or_adjustment_lag_bucket.proto
...
export namespace ConversionOrAdjustmentLagBucketEnum {
  ...
  export interface ConversionOrAdjustmentLagBucketMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
  ...
  export const ConversionOrAdjustmentLagBucket: ConversionOrAdjustmentLagBucketMap;
}
