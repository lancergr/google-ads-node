...
// file: google/ads/googleads/v3/enums/change_status_resource_type.proto
...
export namespace ChangeStatusResourceTypeEnum {
  ...
  export interface ChangeStatusResourceTypeMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    AD_GROUP: 3;
    AD_GROUP_AD: 4;
  ...
  export const ChangeStatusResourceType: ChangeStatusResourceTypeMap;
}
