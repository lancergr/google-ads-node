...
// file: google/ads/googleads/v3/enums/custom_placeholder_field.proto
...
export namespace CustomPlaceholderFieldEnum {
  ...
  export interface CustomPlaceholderFieldMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    ID: 2;
    ID2: 3;
  ...
  export const CustomPlaceholderField: CustomPlaceholderFieldMap;
}
