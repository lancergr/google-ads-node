...
// file: google/ads/googleads/v3/enums/targeting_dimension.proto
...
export namespace TargetingDimensionEnum {
  ...
  export interface TargetingDimensionMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    KEYWORD: 2;
    AUDIENCE: 3;
  ...
  export const TargetingDimension: TargetingDimensionMap;
}
