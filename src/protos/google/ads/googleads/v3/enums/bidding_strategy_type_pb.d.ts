...
// file: google/ads/googleads/v3/enums/bidding_strategy_type.proto
...
export namespace BiddingStrategyTypeEnum {
  ...
  export interface BiddingStrategyTypeMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    COMMISSION: 16;
    ENHANCED_CPC: 2;
  ...
  export const BiddingStrategyType: BiddingStrategyTypeMap;
}
