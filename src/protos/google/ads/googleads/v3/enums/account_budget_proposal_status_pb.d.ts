...
// file: google/ads/googleads/v3/enums/account_budget_proposal_status.proto
...
export namespace AccountBudgetProposalStatusEnum {
  ...
  export interface AccountBudgetProposalStatusMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    PENDING: 2;
    APPROVED_HELD: 3;
  ...
  export const AccountBudgetProposalStatus: AccountBudgetProposalStatusMap;
}
