...
// file: google/ads/googleads/v3/enums/recommendation_type.proto
...
export namespace RecommendationTypeEnum {
  ...
  export interface RecommendationTypeMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    CAMPAIGN_BUDGET: 2;
    KEYWORD: 3;
  ...
  export const RecommendationType: RecommendationTypeMap;
}
