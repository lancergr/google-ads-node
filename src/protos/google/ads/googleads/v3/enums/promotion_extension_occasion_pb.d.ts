...
// file: google/ads/googleads/v3/enums/promotion_extension_occasion.proto
...
export namespace PromotionExtensionOccasionEnum {
  ...
  export interface PromotionExtensionOccasionMap {
    UNSPECIFIED: 0;
    UNKNOWN: 1;
    NEW_YEARS: 2;
    CHINESE_NEW_YEAR: 3;
  ...
  export const PromotionExtensionOccasion: PromotionExtensionOccasionMap;
}
